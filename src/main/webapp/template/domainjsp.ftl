...
<body>
<table id="${domain}Grid" class="easyui-datagrid"
...
<div id="tb" style="padding-top:15px;height:auto">
    ...
    <!-- 这是部门的查询的功能 -->
    <div>
        <form id="searchForm" action="/${domain}/download" method="post">
...
<div id="${domain}Dialog" class="easyui-dialog" title="员工操作" style="width:400px;height:400px;"
     data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true">
    <div style="padding:10px 60px 20px 60px">
        <form id="${domain}Form" method="post">
            <input id="${domain}Id" name="id" type="hidden">
            <table cellpadding="5">
                <tr>
                    <td>名称:</td>
        ...
        <div style="text-align:center;padding:5px">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick=$('#${domain}Form').form('clear')>清除</a>
        </div>
    </div>
</div>
</body>
