...
<div id="tb" style="padding-top:15px;height:auto">
    ...
    <!-- 这是部门的查询的功能 -->
    <div>
        <form id="searchForm" action="/department/download" method="post">
...
<div id="departmentDialog" class="easyui-dialog" title="员工操作" style="width:400px;height:400px;"
    ...
    <div style="padding:10px 60px 20px 60px">
        ...
        <div style="text-align:center;padding:5px">
            ...
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick=$('#departmentForm').form('clear')>清除</a>
        </div>
    </div>
</div>
</body>
